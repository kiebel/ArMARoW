...
struct My_MAC_Config : public armarow::mac::configuration::DefaultMACConfiguration {
    enum {
        channel=3,
...
typedef armarow::mac::MacCsmaCa<My_MAC_Config,platform::config::rc_t,armarow::mac::Enable> Mac_Layer;
Mac_Layer mac;
